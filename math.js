var Homework = /** @class */ (function () {
    ...
    Homework.prototype.animar = function (animado) {
        animado === null || animado === void 0 ? void 0 : animado.classList.add("animar-".concat(animado));
        setTimeout(function () {
            animado === null || animado === void 0 ? void 0 : animado.classList.remove("animar-".concat(animado));
        }, 1000);
    };
