define("genericos", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.borrarHTML = exports.preloadMP3 = exports.sonar = exports.mostrar = exports.esconder = exports.randomNumber = exports.quitarError = exports.animar = void 0;
    const AUDIO_CANTIDAD = 7;
    // Métodos genéricos
    function animar(animado) {
        animado?.classList.add('animar');
        setTimeout(() => {
            animado?.classList.remove('animar');
        }, 1000);
    }
    exports.animar = animar;
    function quitarError() {
        document.getElementById(`respuesta`)?.classList.remove('error');
    }
    exports.quitarError = quitarError;
    function randomNumber(lessThan, min = 0) {
    ...
    exports.preloadMP3 = preloadMP3;
    function borrarHTML(elementoHTML) {
        elementoHTML.innerHTML = '';
    }
    exports.borrarHTML = borrarHTML;
});
// TODO añadir juego igual / distinto
// TODO separar código en módulos
// TODO Añadir tests
define("math", ["require", "exports", "genericos"], function (require, exports, genericos) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Juego;
    (function (Juego) {
    ...
    class Homework {
        ...
        valor_a = genericos.randomNumber(11);
        valor_b = 0;
        operacion = '+';
        gameOverDialog = document.getElementById('game-over');
        vidasNumero = document.getElementById('vidas-numero');
        puntosNumero = document.getElementById('puntos-numero');
        hayNuevoRecordPersonal = false;
